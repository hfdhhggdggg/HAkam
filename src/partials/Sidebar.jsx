...
function Sidebar({
  ...
  const spanClass = "text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200";
  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex lg:flex! flex-col absolute z-40 right-0 top-0 lg:static lg:right-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:w-64! shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "translate-x-64"} ${variant === 'v2' ? 'border-l border-gray-200 dark:border-gray-700/60' : 'rounded-l-2xl shadow-xs'}`}
      >
        {/* Sidebar header */}
        <div className="flex justify-between mb-10 pe-3 sm:px-2">
          {/* Close button */}
          <button
            ref={trigger}
          ...
          >
            ...
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M13.3 5.3L8 10.6l5.3 5.3-1.4 1.4L5.2 10.6 11.9 3.9z" />
            </svg>
          </button>
          {/* Logo */}
        ...
        <div className="space-y-8">
          {/* Pages group */}
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold ps-3">
              <span className="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">
                •••
              </span>
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">الصفحات</span>
            </h3>
            <ul className="mt-3">
              {/* الرئيسية */}
                    ...
                    <React.Fragment>
                      <a
                        ...
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname === "/dashboard" || pathname.includes("dashboard") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current ${pathname === "/dashboard" || pathname.includes("dashboard") ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                          ...
                          <div className="flex shrink-0 ms-2">
                            <svg className={`w-3 h-3 shrink-0 ms-1 fill-current text-gray-400 dark:text-gray-500 ${open && "rotate-180"}`} viewBox="0 0 12 12">
                        ...
                        <ul className={`ps-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/dashboard" className={linkClass}>
                              <span className={spanClass}>نظرة عامة</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/dashboard/stats" className={linkClass}>
                              <span className={spanClass}>إحصائيات</span>
                            </NavLink>
                          </li>
                        </ul>
                      </div>
              ...
              {/* الحكام */}
              <SidebarLinkGroup activecondition={pathname.includes("referee") || pathname.includes("community")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname.includes("referee") || pathname.includes("community") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current ${pathname.includes('referee') || pathname.includes('community') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`ps-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/referees/tabs" className={linkClass}>
                              <span className={spanClass}>قائمة الحكام - Tabs</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/referees/tiles" className={linkClass}>
                              <span className={spanClass}>قائمة الحكام - Tiles</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
              ...
              {/* Messages */}
              <li className={`ps-4 pe-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("messages") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                <NavLink
                  end
                  to="/messages"
                  className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
              ...
              {/* Inbox */}
              <li className={`ps-4 pe-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("inbox") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                <NavLink
                  end
                  to="/inbox"
                  className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium ms-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">طلبات التسجيل</span>
                    </div>
                    {registrationRequests.filter((r) => r.status === 'pending').length > 0 && (
                      <span className="inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 text-xs font-semibold text-white bg-violet-500 rounded-full lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
              ...
              {/* Calendar */}
              <li className={`ps-4 pe-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("calendar") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                <NavLink
                  end
                  to="/calendar"
                  className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
          ...
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold ps-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">المزيد</span>
            </h3>
            <ul className="mt-3">
              {/* Authentication */}
              <SidebarLinkGroup>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`ps-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/signin" className={linkClass}>
                              <span className={spanClass}>تسجيل الدخول</span>
                            </NavLink>
                          </li>
                        </ul>
                      </div>
        ...
        <div className="pt-3 hidden lg:inline-flex 2xl:hidden justify-start mt-auto">
          <div className="w-12 ps-4 pe-3 py-2">
            <button className="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              <span className="sr-only">Expand / collapse sidebar</span>
              <svg className="shrink-0 fill-current text-gray-400 dark:text-gray-500 sidebar-expanded:rotate-180" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                <path d="M1 16a1 1 0 0 1-1-1V1a1 1 0 1 1 2 0v14a1 1 0 0 1-1 1ZM7.414 9H15a1 1 0 1 0 0-2H7.414l2.793-2.793a1 1 0 1 0-1.414-1.414l-4.5 4.5A.997.997 0 0 0 4 7.99M4.076 8.383a.997.997 0 0 0 .217.324l4.5 4.5a1 1 0 0 0 1.414-1.414L7.414 9M4 8.01a.996.996 0 0 1 .076-.373Z" />
              </svg>
            </button>
          </div>
        </div>
