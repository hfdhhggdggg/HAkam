...
function DropdownNotifications({
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`origin-top-left z-10 absolute top-full -ms-48 sm:ms-0 min-w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${align === 'right' ? 'left-0' : 'right-0'}`}
        show={dropdownOpen}
